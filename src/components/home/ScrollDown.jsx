    ...
    return (
        <div className="home-scroll">
            <a href="#about" className="home-scroll-button button-flex">
                <svg width="32px" height="32px" className="home-scroll-mouse" viewBox="0 0 247 390" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    style={
                        {
                            fillRule: "evenodd",
                            clipRule: "evenodd",
                ...
                <div className="uil uil-arrow-down home-scroll-arrow"></div>
            </a>
        </div>
